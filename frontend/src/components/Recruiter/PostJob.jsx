        ...
        >
          ...
          {selectedCompany && (
            <div className="col-span-2 mt-4">
              <Alert
                className={`
                  bg-black border border-cyan-400/20
                  ${companyVerificationStatus === "approved" ? "border-green-400/40 text-green-400" : ""}
                  ${companyVerificationStatus === "pending" ? "border-amber-400/40 text-amber-400" : ""}
                  ${companyVerificationStatus === "rejected" ? "border-red-400/40 text-red-400" : ""}
                `}
              >
                <div className="flex items-center">
                  {checkingStatus ? (
                    <Loader2 className="h-4 w-4 animate-spin mr-2 text-cyan-300" />
                  ...
                  <AlertTitle className="text-white">
                    ...
                    <Badge
                      className={`ml-2 
                        ${companyVerificationStatus === "approved" ? "bg-green-500" : "bg-cyan-500/20"}
                        ${companyVerificationStatus === "pending" ? "bg-amber-500" : ""}
                        ${companyVerificationStatus === "rejected" ? "bg-red-500" : ""}
                        ${!companyVerificationStatus ? "bg-cyan-500/20" : ""}
                      `}
                    >
